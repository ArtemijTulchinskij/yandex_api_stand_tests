...
# Тест 1. Успешное создание пользователя name состоит из 2 символов
def test_create_user_2_letter_in_first_name_get_success_response():
    positive_assert("Aa")

#Тест 2. Успешное создание пользователя Name состоит из 15 символов
...
#Тест 3. Негативный тест на имя одна буква
def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert_symbol("А")

#Тест 4. Негативный тест 16 символов
...
#Функция для проверок когда не передан параметр (пустое поле)
...
#Тест 10. Параметр не передан в запросе. В запросе нет параметра firstName
...
# Тест 11. Ошибка. Параметр fisrtName состоит из пустой строки
